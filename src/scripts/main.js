...
/* forEach method that loops through the array and appends the name and address of each business to the DOM. City is displayed with dot notation. State Code is displayed with square bracket notation. Zip Code is displayed with dynamic square bracket notation. */
